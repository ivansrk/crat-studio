...
describe('статьи репозитория валидны (content/articles: 2 заглушки Ф6 + 6 статей course-factory 15.07 + 1 лонгрид-выпуск 17.07)', () => {
  it('9 статей валидны, без ошибок', () => {
    expect(getArticles().length).toBe(9)
